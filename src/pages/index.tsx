...
export default function LandingPage() {
  ...
  // Get the sections directly from Projects
  const sections = Projects.getSections();

  return (
    <div className="min-h-screen bg-gray-900">
      <div className={`${poppins.variable} ${jetBrainsMono.variable} min-h-screen bg-gray-900 text-white overflow-x-hidden`}>
        <IndexNavigation />

        <main className="w-full bg-gray-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-20 sm:pt-32 pb-20">
            <div className={`transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
              ...
              <Projects onCategoryClick={handleCategoryClick} />
            </div>
          </div>
        </main>
      </div>
