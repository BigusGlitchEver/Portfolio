    ...
    <div className={`${poppins.variable} ${jetBrainsMono.variable} min-h-screen bg-gray-900 text-white`}>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-20">
        ...
        <header className="mb-8 sm:mb-16">
          <h1 className="text-3xl sm:text-5xl font-light mb-4 sm:mb-6">The Judaic Tarot</h1>
          <p className="text-xl sm:text-2xl text-gray-400 mb-6 sm:mb-12">A Jewish deck by and for the Jewish people</p>
          <div className="flex flex-wrap gap-2 sm:gap-4 mb-8 sm:mb-12">
            <span className="px-3 py-1 sm:px-4 sm:py-2 text-sm sm:text-base bg-gray-800/50 rounded-full ring-1 ring-blue-400/20 backdrop-blur-sm">Product Design</span>
            <span className="px-3 py-1 sm:px-4 sm:py-2 text-sm sm:text-base bg-gray-800/50 rounded-full ring-1 ring-blue-400/20 backdrop-blur-sm">Visual Design</span>
            <span className="px-3 py-1 sm:px-4 sm:py-2 text-sm sm:text-base bg-gray-800/50 rounded-full ring-1 ring-blue-400/20 backdrop-blur-sm">Research</span>
            <span className="px-3 py-1 sm:px-4 sm:py-2 text-sm sm:text-base bg-gray-800/50 rounded-full ring-1 ring-blue-400/20 backdrop-blur-sm">Publications</span>
            <span className="px-3 py-1 sm:px-4 sm:py-2 text-sm sm:text-base bg-gray-800/50 rounded-full ring-1 ring-blue-400/20 backdrop-blur-sm">Photo Editing</span>
          </div>
        ...
        <section className="mb-16 sm:mb-32">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
            <div className="bg-gray-800/50 p-6 sm:p-8 rounded-2xl backdrop-blur-sm ring-1 ring-blue-400/20">
              <h2 className="text-xl sm:text-2xl font-light mb-4 sm:mb-6">The Gap</h2>
            ...
            <div className="bg-gray-800/50 p-6 sm:p-8 rounded-2xl backdrop-blur-sm ring-1 ring-blue-400/20">
              <h2 className="text-xl sm:text-2xl font-light mb-4 sm:mb-6">The Impact</h2>
              <p className="text-base sm:text-xl text-gray-300">
          ...
          <div className="mt-4 sm:mt-8 bg-gray-800/50 p-6 sm:p-8 rounded-2xl backdrop-blur-sm ring-1 ring-blue-400/20">
            <h2 className="text-xl sm:text-2xl font-light mb-4">The Solution</h2>
            <p className="text-base sm:text-xl text-gray-300">
        ...
        <section className="mb-16 sm:mb-32">
          <h2 className="text-2xl sm:text-4xl font-light mb-6 sm:mb-8">Research & Development</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
            ...
            <div className="bg-gray-800/50 p-6 sm:p-8 rounded-2xl backdrop-blur-sm ring-1 ring-blue-400/20 h-fit">
              <h3 className="text-xl sm:text-2xl font-light mb-4 sm:mb-6">Key Findings</h3>
              <ul className="space-y-3 sm:space-y-4">
                <li className="text-base sm:text-xl text-gray-300">• Traditional tarot decks often draw from Jewish mysticism without acknowledging the source</li>
                <li className="text-base sm:text-xl text-gray-300">• Jewish readers sought deeper connections to their cultural heritage through tarot</li>
                <li className="text-base sm:text-xl text-gray-300">• The intersection of Jewish tradition and tarot presented unique opportunities for authentic representation</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 sm:mb-32">
          <h2 className="text-2xl sm:text-4xl font-light mb-6 sm:mb-8">Card Design</h2>
          
          {/* Major Arcana */}
          <div className="mb-12 sm:mb-16">
            <h3 className="text-xl sm:text-2xl font-light mb-4 sm:mb-6">Major Arcana</h3>
          ...
          {/* Minor Arcana */}
          <div className="mb-12 sm:mb-16">
            <h3 className="text-xl sm:text-2xl font-light mb-4 sm:mb-6">Minor Arcana</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 mb-4 sm:mb-8">
              <div className="rounded-2xl overflow-hidden">
                <Image 
                  src="/ace.png"
          ...
          {/* Card Back Design */}
          <div>
            <h3 className="text-xl sm:text-2xl font-light mb-4 sm:mb-6">Card Back Design</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
              <div className="rounded-2xl overflow-hidden">
                <Image 
                  src="/backs.png"
        ...
        {/* Companion Book */}
        <section className="mb-16 sm:mb-32">
          <h2 className="text-2xl sm:text-4xl font-light mb-6 sm:mb-8">The Companion Book</h2>
